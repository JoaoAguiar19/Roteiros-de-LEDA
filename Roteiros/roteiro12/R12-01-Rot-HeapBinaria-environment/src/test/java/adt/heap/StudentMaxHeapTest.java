...
public class StudentMaxHeapTest {
	...
	public void testInsertNull() {
		...
		assertFalse(heap.isEmpty());
		verifyHeap(new Integer[] { 14, 10, 5, 8 });
	...
	public void testRootElement() {
		...
		assertEquals(Integer.valueOf(14), heap.rootElement());

		// Mudando o root
		heap.insert(21);
		assertEquals(Integer.valueOf(21), heap.rootElement());
		verifyHeap(new Integer[] { 21, 14, 10, 5, 8 });
	}
}
