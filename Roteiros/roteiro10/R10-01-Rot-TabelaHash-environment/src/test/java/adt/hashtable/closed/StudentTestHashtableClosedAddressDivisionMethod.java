...
public class StudentTestHashtableClosedAddressDivisionMethod {
	...
	public void setUp() throws Exception {
		...
		table3 = new HashtableClosedAddressImpl<Integer>(2, HashFunctionClosedAddressMethod.DIVISION);
	...
	public void testRemoveNull() {
		...
		HashtableClosedAddressImpl<Integer> table4 = new HashtableClosedAddressImpl<Integer>(3, HashFunctionClosedAddressMethod.DIVISION);
		table4.remove(9);
		table4.insert(9);
	...
	public void testIndexOf() {
		HashtableClosedAddressImpl<Integer> table4 = new HashtableClosedAddressImpl<Integer>(3, HashFunctionClosedAddressMethod.DIVISION);
		table4.insert(9);
		assertEquals(0, table4.indexOf(9));
		assertEquals(-1, table4.indexOf(null));
		
		
		assertEquals(-1, table3.indexOf(6));
