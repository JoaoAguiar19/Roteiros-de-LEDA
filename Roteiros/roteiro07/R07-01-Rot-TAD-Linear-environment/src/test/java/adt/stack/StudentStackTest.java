...
public class StudentStackTest {
	...
	public void testPushComErro() throws StackOverflowException {
		stack2.push(new Integer(5)); // enche a pilha
	...
	@Test
	public void testTopAfterPop() throws StackUnderflowException {
		assertEquals(new Integer(3), stack1.top());
		stack1.pop(); // remove 3
	...
	@Test
	public void testIsFullTransition() throws StackOverflowException {
		stack3.push(1);
		stack3.push(2);
