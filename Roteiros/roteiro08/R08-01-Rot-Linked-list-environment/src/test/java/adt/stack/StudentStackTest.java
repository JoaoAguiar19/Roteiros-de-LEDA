...
public class StudentStackTest {
	...
	@Test
	public void testTopEmPilhaVazia() {
		assertNull(stack3.top());
	}

	@Test
	public void testIsEmptyEIsFullAposOperacoes() throws StackOverflowException, StackUnderflowException {
	...
	@Test
	public void testPushNullNaoAlteraPilha() throws StackOverflowException {
		stack1.push(null);
